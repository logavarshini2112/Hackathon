...
import { Bell, CheckCheck, Flame, UserCheck, Shield, Info } from 'lucide-react';

export default function AdminNotificationPanel({ notifications, onMarkAllRead }) {
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Live escalation alerts and operational logs</p>
          </div>
        </div>
