...
import { Bell, CheckCheck, AlertTriangle, ShieldAlert, Info, Shield } from 'lucide-react';

export default function StaffNotificationCard({ notifications, onMarkAllRead }) {
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Department assignments and SLA alerts</p>
          </div>
        </div>
