...
export default function AdminSidebar({ activeSection, setActiveSection, onLogoutClick, isMobileOpen, setIsMobileOpen }) {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'feedback-management', label: 'Feedback Management', icon: FileText },
    { id: 'staff-management', label: 'Staff Management', icon: Users },
    { id: 'escalated-feedback', label: 'Escalated Feedback', icon: Flame },
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-slate-950 text-slate-300 flex flex-col justify-between transition-transform duration-300 ease-in-out lg:translate-x-0 ${
