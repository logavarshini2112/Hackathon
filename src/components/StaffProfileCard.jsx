...
import { User, Mail, Phone, ShieldCheck, Edit3, Key, X, Info, Building } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl border border-slate-100 space-y-4 text-center relative">
            ...
            <p className="text-xs text-slate-500">
              The {comingSoonFeature} feature will be enabled in the upcoming staff system update.
            </p>
